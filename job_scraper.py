...
VERIFIED_JOBS_MASTER = [
    ...
    {
        "id": "job-korail-2026-02",
        "company": "한국철도공사",
        "category_id": "public",
        "category_name": "공기업·공공기관",
        "badge_color": "emerald",
        "title": "2026년 하반기 한국철도공사 토목직(선로/구조물) 신입사원 공채",
        "fields": ["선로유지관리", "철도교량·터널 시설관리", "궤도공학"],
        "career": "신입 (채용형인턴)",
        "education": "학력무관 (블라인드)",
        "location": "전국 본사 및 지역관리단",
        "period": "2026.09.17 ~ 10.06 (14:00 마감)",
        "deadline_date": "2026-10-06",
        "salary": "초임 연 4,050만원 수준 (성과급 별도)",
        "tags": ["블라인드 채용", "철도무료이용", "사택 지원", "토목기사 우대"],
        "link": "https://info.korail.com/info/selectBbsNttList.do?bbsNo=199&key=911",
        "summary": "전국 고속철도 및 일반철도 선로, 터널, 교량의 구조적 안전과 첨단 궤도 인프라 시공·유지를 담당할 신입사원을 채용합니다.",
        "qualifications": "연령/학력 제한 없음 (단, 남자는 병역필 또는 면제자), 토목기사, 철도보선기사 자격증 소지자 서류 및 필기 가점",
        "steps": ["서류검증 (적부)", "필기시험 (NCS + 전공직무)", "실기/면접시험", "철도적성검사", "채용형인턴 (정규직 전환)"]
    },
    {
        "id": "job-hdec-2026-03",
        "company": "현대건설",
